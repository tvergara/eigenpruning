...
import einops
import torch
from training.constants import PREACTIVATION_NAMES
...
def compute_effect(
    ...
    for layer in layers:
        for component in components:
            grad = gradients[(layer, component)]
            decompositions = singular_values[(layer, component)]
            preactivation_name = PREACTIVATION_NAMES[component]
            ...
            if component == 'result':
                ...
                effects[(layer, component)] = effect

            elif component in ['pre', 'mlp_out']:
